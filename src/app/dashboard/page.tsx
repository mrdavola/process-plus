                ...
                <div className="mb-12 bg-white rounded-2xl p-6 shadow-sm border border-brand-amber/10">
                    ...
                    <form onSubmit={handleCreateStudio} className="flex gap-3">
                        ...
                        <button
                            ...
                            className="px-6 py-3 bg-brand-amber hover:bg-brand-amber/90 text-white font-bold rounded-xl transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
